    ...
    def update(self,frame_time):
        ...
        if total_frametime > 0.1:
            ...
            for i in range(len(bastion)):  # 바스티온의 주인공 인식
                ...
                dota = self.bastion_sence(bastion[i], mainhero)
            ...
            for i in range(len(enemyatack)):
                enemyatack[i].update()
                delatack = 0
                if self.collide(mainhero, enemyatack[i]) and delatack == 0 and mainhero.get_hp() > 0:  # 주인공 피격 후 hp감소
            ...
            if worldy > 7000:
                if boss.get_hp() > 0:
                    ...
                    for i in range(len(bosstan)):
                        ...
                        if self.collide(mainhero, bosstan[i]) and delatack == 0 and mainhero.get_hp() > 0:
